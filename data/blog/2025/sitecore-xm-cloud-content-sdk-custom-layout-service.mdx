...
No sweat! 🥵 <br /> If you noticed from the page route request that Sitecore uses a separate method when in page builder mode, called `client.getPreview(...)`.
...
🤘 Shout out to my colleague @Nishtech, [Olivier McNicoll](https://www.linkedin.com/in/olivier-mcnicoll-62729290), for the collaboration on this Chef's Kiss extension point 🤘