...
![micro-frontend and microservices by vertical](/public/static/images/blog-content-images/mf/mf_verticals.png)
...
![module federation ecosystem](/public/static/images/blog-content-images/mf/mf_ecosystem.png)

### Module Federation Ecosystem - Build Tools

Rspack, Webpack, and Vite are the currently supposed build tools, implemented as Module Federation npm plugins. Plugins must be installed on both the Remote and Host applications.
...
![SPA module-level application micro-frontend diagram example](/public/static/images/blog-content-images/mf/mf_bridge-app-mode.png)
...
## Up Next
- Injecting Federated Next.js React Components in Sitecore Next.js Applications
- Injecting Sitecore Layout Data and Components into non-Sitecore Next.js Applications
