...
- In [Part 2](/blog/2025/microfrontends-part-3-federated-component-api-to-sitecore-apps) of this series, we will learn how to use Module Federation to expose components from a Remote App right into your Sitecore Next.js App with type generation.
