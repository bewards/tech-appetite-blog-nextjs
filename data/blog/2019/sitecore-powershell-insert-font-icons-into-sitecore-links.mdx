...
date: '2019-10-06'
summary: Learn how to manipulate Sitecore data from Rich-Text Editor fields with Sitecore PowerShell in order to add different types of font icons to Sitecore Links
tags: ['sitecore powershell extensions', 'sitecore']
draft: false
images: ['/static/images/blog-thumbnails/sitecore-and-powershell.jpg']
authors: ['default']
---
